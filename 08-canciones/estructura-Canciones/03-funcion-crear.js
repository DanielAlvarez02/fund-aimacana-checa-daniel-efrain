...
function crear() {
    return __awaiter(this, void 0, void 0, function () {
        var cancionesInicialPregunta, cancionesInicial, cantidadDeCanciones, directorio, i, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    cancionesInicialPregunta = {
                        type: 'number',
                        name: 'numeroDeOpcion',
                        message: '¿Cuantas canciones quiere agregar?',
                        validate: function (value) { return value < 0 ? "Debe ser un numero mayor a 0." : true; }
                    };
                    return [4 /*yield*/, prompts(cancionesInicialPregunta)];
                case 1:
                    cancionesInicial = _c.sent();
                    cantidadDeCanciones = cancionesInicial.numeroDeOpcion;
                    directorio = [];
                    i = 0;
                    _c.label = 2;
                case 2:
                    if (!(i < cantidadDeCanciones)) return [3 /*break*/, 5];
                    _a = directorio;
                    _b = i;
                    return [4 /*yield*/, _02_funcion_pedir_datos_1.datosCanciones()];
                case 3:
                    _a[_b] = _c.sent();
                    _c.label = 4;
                case 4:
