...
function eliminar(directorio) {
    return __awaiter(this, void 0, void 0, function () {
        var tablaCancionesBuscar, opcion, opcionRespuesta, numeroDeOpcion, _a, indiceEncontrado, cancionEncontrada_1, indiceCancionEncontrada;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    opcion = {
                        ...
                        validate: function (value) { return (value < 0 || value > 2) ? "Escoger solo opcionese existentes" : true; }
                    };
                ...
                case 4:
                    ...
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, _13_buscar_por_nombre_1.buscarCancionPorNombre(directorio)];
                case 6:
                    cancionEncontrada_1 = _b.sent();
                    indiceCancionEncontrada = directorio.findIndex(function (valorActual, indice) {
                        if (valorActual.nombre == cancionEncontrada_1.nombre) {
                            return indice;
                        }
                    });
                    directorio.splice(indiceCancionEncontrada, 1);
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/, directorio];
            }
        });
    });
}
