...
var _15_funcion_editar_pelicula_1 = require("./15-funcion-editar-pelicula");
function editarDirectorio(directorio) {
    return __awaiter(this, void 0, void 0, function () {
        var tablaCancionesBuscar, opcion, opcionRespuesta, numeroDeOpcion, _a, indiceEncontrado, _b, _c, peliculaEncontrada_1, indicePeliculaEncontrada, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0: return [4 /*yield*/, _10_funcion_tabla_1.realizarTabla(directorio)];
                case 1:
                    tablaCancionesBuscar = _f.sent();
                    console.log('\n¿Cómo desea buscar ?:\n');
                ...
                case 4:
                    ...
                    _b = directorio;
                    _c = indiceEncontrado;
                    return [4 /*yield*/, _15_funcion_editar_pelicula_1.editar(directorio[indiceEncontrado])];
                case 5:
                    _b[_c] = _f.sent();
                    return [3 /*break*/, 9];
                ...
                case 7:
                    ...
                    _d = directorio;
                    _e = indicePeliculaEncontrada;
                    return [4 /*yield*/, _15_funcion_editar_pelicula_1.editar(directorio[indicePeliculaEncontrada])];
                case 8:
                    _d[_e] = _f.sent();
                    return [3 /*break*/, 9];
                case 9: return [2 /*return*/, directorio];
            }
        });
    });
}
exports.editarDirectorio = editarDirectorio;
